...
let nameGreeting = nameCheck (`Egha`)
...
function theEliminator(contestants,loser){
  for(let i=0; i< contestants.length; i++ ){
    // console.log(`${contestants[i]} and ${loser} `)
...
function ChocoFrogBuyer(gold) { 
let totalChocolate = gold / 3
return totalChocolate
}
let totalFrogs = ChocoFrogBuyer(22)
...
//CODE HERE
function ChocoFrogBuyer2(gold) { 
let totalChocolate = Math.floor(gold / 3)
return totalChocolate
}
let totalFrogs2 = ChocoFrogBuyer2(22)
console.log(totalFrogs2)

////////////////// PROBLEM 14 ////////////////////
let sampleArray = [0,1,5,3,4,5,6,7,8,9]
/*
  Write a function that takes in an array of numbers as an argument. In the body of the function, write logic to determine if the array is in ascending order. The function should return true, if it is sorted in ascending order, false if it is not. Create a variable, `arrayIsAscending` and set it equal to your function invoked. Use the sample array to test this function.
*/

function arrayOrder(nums) {
